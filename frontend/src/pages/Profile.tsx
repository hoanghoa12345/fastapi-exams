...
const ProfilePage = () => {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      const token = Cookies.get("token") || "";
      await authApi.update(token, data);
      toast({
            ...
            <chakra.form
              ...
              <Stack
                ...
                <SimpleGrid columns={6} spacing={6}>
                  <FormControl as={GridItem} colSpan={[6, 3]} isInvalid={errors.first_name ? true : false}>
                    <FormLabel
                      htmlFor="first_name"
                      fontSize="sm"
                      fontWeight="md"
                  ...
                  <FormControl as={GridItem} colSpan={[6, 3]} isInvalid={errors.last_name ? true : false}>
                    <FormLabel
                      htmlFor="last_name"
                      fontSize="sm"
                      fontWeight="md"
                  ...
                  <FormControl as={GridItem} colSpan={[6, 4]} isInvalid={errors.email ? true : false}>
                    <FormLabel
                  ...
                  <FormControl as={GridItem} colSpan={[6, 4]} isInvalid={errors.phone ? true : false}>
                    <FormLabel
                      htmlFor="phone"
                      fontSize="sm"
                      fontWeight="md"
                  ...
                  <FormControl as={GridItem} colSpan={6} isInvalid={errors.address ? true : false}>
                    <FormLabel
